...
public:
  ...
  /**
   * Computes if the triangleAttempt is a valid triangle or not.
   * Valid means that the best_score is above 0.
   * Also computes some other parameters like the arrows.
   *
   * @param bb:       Bounding Box, intersection point must lie within
   * @param clusters  All clusters, needed for performing the calculations
   */
